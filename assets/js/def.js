...
function initRightclickRenameFolderTippy(id, pUserCanDelete) {
	...
	var html = '';
	if (pUserCanDelete) {
    	html = html + '<a data-toggle="modal" class="modal-link" href="#contentBasicEditFolder' + id + '" style="margin-left: 0;">Rename</a>';

        html = html + '<br><a class="delete-icon" href="javascript:;" title="Delete" data-request="onDeleteFolder" data-request-data="id:  ' + id + '"  data-request-confirm="Are you sure you want to delete?">Delete</a>';
    }
...
function initExtAccordeon(pElem) {
